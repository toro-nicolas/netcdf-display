 ...
 * @return <b>void</b>
 */
void display_attribute_byte(file_information_t *in_ps_file_info,
                            int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    signed char *value = (signed char *)calloc(i_att_len, sizeof(signed char));

    ERROR(nc_get_att_schar(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
 ...
 * @return <b>void</b>
 */
void display_attribute_char(file_information_t *in_ps_file_info,
                            int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    char *value = (char *)calloc(i_att_len, sizeof(char));

    ERROR(nc_get_att_text(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = %s\n", value);
    free(value);
}
 ...
 * @return <b>void</b>
 */
void display_attribute_short(file_information_t *in_ps_file_info,
                             int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    short *value = (short *)calloc(i_att_len, sizeof(short));

    ERROR(nc_get_att_short(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_int(file_information_t *in_ps_file_info,
                           int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    int *value = (int *)calloc(i_att_len, sizeof(int));

    ERROR(nc_get_att_int(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_float(file_information_t *in_ps_file_info,
                             int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    float *value = (float *)calloc(i_att_len, sizeof(float));

    ERROR(nc_get_att_float(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_double(file_information_t *in_ps_file_info,
                              int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    double *value = (double *)calloc(i_att_len, sizeof(double));

    ERROR(nc_get_att_double(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
        printf("%f", value[i_index]);
        if (i_index + 1 < i_att_len)
 ...
 * @return <b>void</b>
 */
void display_attribute_ubyte(file_information_t *in_ps_file_info,
                             int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    unsigned char *value = (unsigned char *)calloc(i_att_len, sizeof(unsigned char));

    ERROR(nc_get_att_ubyte(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_ushort(file_information_t *in_ps_file_info,
                              int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    unsigned short *value = (unsigned short *)calloc(i_att_len, sizeof(unsigned short));

    ERROR(nc_get_att_ushort(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_uint(file_information_t *in_ps_file_info,
                            int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    unsigned int *value = (unsigned int *)calloc(i_att_len, sizeof(unsigned int));

    ERROR(nc_get_att_uint(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_int64(file_information_t *in_ps_file_info,
                             int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    long long *value = (long long *)calloc(i_att_len, sizeof(long long));

    ERROR(nc_get_att_longlong(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_uint64(file_information_t *in_ps_file_info,
                              int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    unsigned long long *value = (unsigned long long *)calloc(i_att_len, sizeof(unsigned long long));

    ERROR(nc_get_att_ulonglong(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
 ...
 * @return <b>void</b>
 */
void display_attribute_string(file_information_t *in_ps_file_info,
                              int32_t i_var_id, size_t i_att_len, char *ac_att_name)
{
    char **value = (char **)calloc(i_att_len, sizeof(char *));

    ERROR(nc_get_att_string(in_ps_file_info->i_file_id, i_var_id, ac_att_name, value));
    printf("  - value = [");
    for (size_t i_index = 0; i_index < i_att_len; i_index++) {
...
{
    static void (*display_attribute[])(file_information_t *in_ps_file_info,
    int32_t i_var_id, size_t i_att_len, char *ac_att_name) = {
    ...
    ERROR(nc_inq_attname(in_ps_file_info->i_file_id, i_var_id, i_att_id, ac_att_name));
    ERROR(nc_inq_att(in_ps_file_info->i_file_id, i_var_id, ac_att_name, &i_type, &i_att_len));
    printf(BOLD "%sAttribute %d:\n" RESET, ac_tab, i_att_id);
    printf("%s  - name = %s\n", ac_tab, ac_att_name);
    printf("%s  - type = %s\n", ac_tab, apc_type_list[((i_type > 12 || i_type < 0) ? 0 : i_type)]);
    printf("%s  - length = %zu\n%s", ac_tab, i_att_len, ac_tab);
    display_attribute[i_type](in_ps_file_info, i_var_id, i_att_len, ac_att_name);
}
...
{
    printf("\n    " BOLD UNDERLINE "Globals attributes: %d\n" RESET, in_ps_file_info->i_nb_attributes);
    for (int i_att_id = 0; i_att_id < in_ps_file_info->i_nb_attributes; i_att_id++)
        display_attribute(in_ps_file_info, NC_GLOBAL, i_att_id, "");
}
